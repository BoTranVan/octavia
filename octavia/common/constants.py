...
DELETE_DISTRIBUTOR_FLOW = 'octavia-delete-distributor-flow'
...
UPDATE_DISTRIBUTOR_FLOW = 'octavia-update-distributor-flow'
...
REGISTER_AMP_SUBFLOW = 'octavia-register-amp-subflow'
...
MARK_AMP_ACTIVE_INDB = 'octavia-mark-amp-active-indb'
GET_VRRP_SUBFLOW = 'octavia-get-vrrp-subflow'
GET_BGP_SUBFLOW = 'octavia-get-bgp-subflow'
...
AMP_UPDATE_FRONTEND_INTF = 'octavia-amphora-update-frontend-intf'
...
TOPOLOGY_ACTIVE_ACTIVE = 'ACTIVE_ACTIVE'
ROLE_MASTER = 'MASTER'
ROLE_BACKUP = 'BACKUP'
ROLE_STANDALONE = 'STANDALONE'
ROLE_ACTIVE = 'ACTIVE'

SUPPORTED_LB_TOPOLOGIES = (TOPOLOGY_ACTIVE_STANDBY,
                           TOPOLOGY_SINGLE, TOPOLOGY_ACTIVE_ACTIVE)
...
# Cluster Quota Constants
MIN_CLUSTERQUOTA = QUOTA_UNLIMITED
MAX_CLUSTERQUOTA = 2000000000
CLUSTERQUOTA_DB_ID = '00000000-0000-0000-0000-000000000000'
...
RBAC_CLUSTERQUOTA = '{}:clusterquota:'.format(LOADBALANCER_API)
...
# Distributor
MAX_AMPHORA_NUM = 'max_amphora_num'
MIN_AMPHORA_NUM = 'min_amphora_num'
