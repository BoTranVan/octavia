...
class TestEndpoint(base.TestCase):
    ...
    def test_extension_load_balancer(self):
        self.ep.extension_load_balancer(self.context, self.resource_id)
        self.ep.worker.extension_loadbalancer.assert_called_once_with(
            self.resource_id)
