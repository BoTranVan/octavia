...
%changelog
* Thu Aug 30 2018 RDO <dev@lists.rdoproject.org> 3.0.0-1
- Update to 3.0.0

* Wed Aug 22 2018 RDO <dev@lists.rdoproject.org> 3.0.0-0.3.0rc2
- Update to 3.0.0.0rc3

* Tue Aug 21 2018 RDO <dev@lists.rdoproject.org> 3.0.0-0.2.0rc1
